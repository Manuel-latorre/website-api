...
export default function LoginUser (){
  ...
  const handleToggleOutput = () => {
    ...
    function copyToClipboard() {
        const code = document.getElementById('codeLoginUser');
        if (code) {
        ...
        <div id="loginUser">
            <div className="mt-10">
                <div className="flex items-center justify-between">
                    <p className="text-xl text-slate-300">Login user</p>
                    <Button variant="flat" color="success" size="sm" className="max-md:hidden">POST</Button>
                </div>
                ...
                <section className="bg-slate-300 p-5 rounded-md mt-5 flex justify-between items-center max-md:p-3 min-w-[320px]">
                    <code id="codeLoginUser">
                        <p>fetch(&#39;https://api-gaming.vercel.app/login&#39;, {'{'} <br/></p>
                            method: &quot;POST&quot;,<br/>
