...
export default function DecreaseQuantity (){
  ...
  const handleToggleOutput = () => {
    ...
    function copyToClipboard() {
        const code = document.getElementById('codeDecrease');
        if (code) {
        ...
        <div id="decreaseQuantity">
            <div className="mt-10">
                <div className="flex items-center justify-between">
                    <p className="text-xl text-slate-300">Decrease product quantity</p>
                    <Button variant="flat" color="secondary" size="sm" className="max-md:hidden">PUT</Button>
                </div>
                ...
                <code id="codeDecrease">
                        <p>fetch(&#39;https://api-gaming.vercel.app/products-cart/productId?query=del&#39;, {'{'} <br/></p>
                            method: &quot;PUT&quot;,<br/>
                            body: JSON.stringify(<br/>
                                <p className="ml-7">{'{'}</p>
                                    <p className="ml-12">amount: 1</p>
