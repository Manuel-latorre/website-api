  ...
  return (
    ...
    >
      ...
      <NavbarContent className="lg:hidden pr-3" justify="center">
        <NavbarBrand>
            <svg width={40} height={40} fill="#ffffff" viewBox="0 0 32 32" version="1.1" xmlns="http://www.w3.org/2000/svg" stroke="#ffffff" stroke-width="0.00032"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"> <title>console-window</title> <path d="M0 26.016q0 2.496 1.76 4.224t4.256 1.76h20q2.464 0 4.224-1.76t1.76-4.224v-20q0-2.496-1.76-4.256t-4.224-1.76h-20q-2.496 0-4.256 1.76t-1.76 4.256v20zM4 26.016v-14.016h24v14.016q0 0.832-0.576 1.408t-1.408 0.576h-20q-0.832 0-1.44-0.576t-0.576-1.408zM4 10.016v-4q0-0.832 0.576-1.408t1.44-0.608h20q0.8 0 1.408 0.608t0.576 1.408v4h-24zM6.016 20h1.984v-1.984h-1.984v1.984zM6.016 16h1.984v-1.984h-1.984v1.984zM6.016 8h1.984v-1.984h-1.984v1.984zM8 18.016h2.016v-2.016h-2.016v2.016zM10.016 22.016h4v-2.016h-4v2.016zM10.016 8h1.984v-1.984h-1.984v1.984zM14.016 8h12v-1.984h-12v1.984z"></path> </g></svg>
        </NavbarBrand>
      </NavbarContent>
      ...
      <NavbarContent justify="end">
        ...
        <NavbarMenu className="bg-slate-700">
            <section className="flex justify-around mt-5 border-b-1 border-slate-500">
                <NavbarItem>
                    <Link href="/" className="text-white text-lg pb-4">
                        Home
                    </Link>
                </NavbarItem>
                <NavbarItem>
                    <Link href="/docs" className="text-white text-lg pb-4">
                        Docs
                    </Link>
                </NavbarItem>
                <NavbarItem>
                    <Link href="https://github.com/Manuel-latorre/website-api" className="text-white text-lg pb-4">
                        Github
                    </Link>
                </NavbarItem>
            </section>
            <section className="mt-10 flex flex-col gap-5">
                ...
                <NavbarItem>
                    <Dropdown backdrop="blur">
                        <DropdownTrigger>
                          <Button variant="light" className="flex justify-start">
                            <p className="text-emerald-400 tracking-widest text-lg font-bold">GET</p>
                            <svg className="ml-1" width={10} height={10} viewBox="0 -4.5 20 20" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" fill="#34d399"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"> <title>arrow_down [#339]</title> <desc>Created with Sketch.</desc> <defs> </defs> <g id="Page-1" stroke-width="0.0002" fill="none" fill-rule="evenodd"> <g id="Dribbble-Light-Preview" transform="translate(-180.000000, -6684.000000)" fill="#34d399"> <g id="icons" transform="translate(56.000000, 160.000000)"> <path d="M144,6525.39 L142.594,6524 L133.987,6532.261 L133.069,6531.38 L133.074,6531.385 L125.427,6524.045 L124,6525.414 C126.113,6527.443 132.014,6533.107 133.987,6535 C135.453,6533.594 134.024,6534.965 144,6525.39" id="arrow_down-[#339]"> </path> </g> </g> </g> </g></svg>
                          </Button>
                        </DropdownTrigger>
                ...
                <NavbarItem>
                    <Dropdown backdrop="blur">
                        <DropdownTrigger>
                        <Button variant="light" className="flex justify-start">
                            <p className="text-cyan-500 tracking-widest text-lg font-bold">POST</p>
                            <svg className="ml-1" width={10} height={10} viewBox="0 -4.5 20 20" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" fill="#06b6d4"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"> <title>arrow_down [#339]</title> <desc>Created with Sketch.</desc> <defs> </defs> <g id="Page-1" stroke-width="0.0002" fill="none" fill-rule="evenodd"> <g id="Dribbble-Light-Preview" transform="translate(-180.000000, -6684.000000)" fill="#06b6d4"> <g id="icons" transform="translate(56.000000, 160.000000)"> <path d="M144,6525.39 L142.594,6524 L133.987,6532.261 L133.069,6531.38 L133.074,6531.385 L125.427,6524.045 L124,6525.414 C126.113,6527.443 132.014,6533.107 133.987,6535 C135.453,6533.594 134.024,6534.965 144,6525.39" id="arrow_down-[#339]"> </path> </g> </g> </g> </g></svg>
                          </Button>
                        </DropdownTrigger>
                        <DropdownMenu aria-label="Static Actions">
                          <DropdownItem key="new">New file</DropdownItem>
                ...
                <NavbarItem>
                    <Dropdown backdrop="blur">
                        <DropdownTrigger>
                        <Button variant="light" className="flex justify-start">
                            <p className="text-orange-500 tracking-widest text-lg font-bold">PUT</p>
                            <svg className="ml-1" width={10} height={10} viewBox="0 -4.5 20 20" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" fill="#f97316"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"> <title>arrow_down [#339]</title> <desc>Created with Sketch.</desc> <defs> </defs> <g id="Page-1" stroke-width="0.0002" fill="none" fill-rule="evenodd"> <g id="Dribbble-Light-Preview" transform="translate(-180.000000, -6684.000000)" fill="#f97316"> <g id="icons" transform="translate(56.000000, 160.000000)"> <path d="M144,6525.39 L142.594,6524 L133.987,6532.261 L133.069,6531.38 L133.074,6531.385 L125.427,6524.045 L124,6525.414 C126.113,6527.443 132.014,6533.107 133.987,6535 C135.453,6533.594 134.024,6534.965 144,6525.39" id="arrow_down-[#339]"> </path> </g> </g> </g> </g></svg>
                          </Button>
                        </DropdownTrigger>
                        <DropdownMenu aria-label="Static Actions">
                          <DropdownItem key="new">New file</DropdownItem>
                ...
                <NavbarItem>
                    <Dropdown backdrop="blur">
                        <DropdownTrigger>
                        <Button variant="light" className="flex justify-start">
                            <p className="text-rose-600 tracking-widest text-lg font-bold">DELETE</p>
                            <svg className="ml-1" width={10} height={10} viewBox="0 -4.5 20 20" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" fill="#e11d48"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"> <title>arrow_down [#339]</title> <desc>Created with Sketch.</desc> <defs> </defs> <g id="Page-1" stroke-width="0.0002" fill="none" fill-rule="evenodd"> <g id="Dribbble-Light-Preview" transform="translate(-180.000000, -6684.000000)" fill="#e11d48"> <g id="icons" transform="translate(56.000000, 160.000000)"> <path d="M144,6525.39 L142.594,6524 L133.987,6532.261 L133.069,6531.38 L133.074,6531.385 L125.427,6524.045 L124,6525.414 C126.113,6527.443 132.014,6533.107 133.987,6535 C135.453,6533.594 134.024,6534.965 144,6525.39" id="arrow_down-[#339]"> </path> </g> </g> </g> </g></svg>
                          </Button>
                        </DropdownTrigger>
                        <DropdownMenu aria-label="Static Actions">
                          <DropdownItem key="new">New file</DropdownItem>
            ...
            <section className="mt-10 flex flex-col gap-5">
                ...
                <ul className="flex flex-col ml-3 gap-4">
                    <li>
                        <Link onClick={() => setIsMenuOpen(false)} href="#getAllProducts" className="text-xl text-slate-300 hover:bg-slate-500 gap-2">
                    ...
                    <li>
                        <Link onClick={() => setIsMenuOpen(false)} href="#getCartProducts" className="text-xl text-slate-300 hover:bg-slate-500 gap-2">
                    ...
                    <li>
                        <Link onClick={() => setIsMenuOpen(false)} href="#getAllUsers" className="text-xl text-slate-300 hover:bg-slate-500 gap-2">
